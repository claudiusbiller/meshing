...
PostOperation {
  { Name Map; NameOfPostProcessing EleSta_v;
    Operation {
      ...
      Print[ capacitance[Vol_Vacuum], OnGlobal, Format Table, Depth 0, File "capacitance.csv" ];
      Print[ normals, OnElementsOf HelixSurf, Format ElementTable, File "normals.pos" ];
    }
  }
}
